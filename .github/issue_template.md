...
<!-- Please verify the issue is present in the latest version by installing it with `pip install boilerdata==0.0.1` and checking that the bug is still there #} -->

- [ ] This bug affects version `0.0.1` of `boilerdata`.
